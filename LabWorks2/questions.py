'''
1. Check whether 5 is in list of first 5 natural numbers or not. Hint -> [1,2,3,4,5]
2. WAP which accpts marks of four subjects and display total marks, percentage and grade.
    Hint: more that 70% -> distinction, more than 60% -> first, more that 40% -> pass, less than 40% -> fail
3. Check whether the user input number is even or odd and display it to the user.
...
15.What will be the output of the following if
 a =2, b=3, c =4, d = 3?
 a)a==b
 b)a!=d
 c)b==d
